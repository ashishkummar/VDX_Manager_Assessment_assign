...
const Goals = ({designerSelected}) => {
     ...
     //console.log(designerSelected?.data["2021"][0].values[0].rating); 
    // console.log("designerSelected = ", designerSelected)
     
 //console.log(designerSelected?.data["2022"][0].values[0].rating);
